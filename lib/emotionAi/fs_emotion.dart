...
class EmotionAI {
  ...
  void startEAICollectForView(String nameScreen) {
    ...
    this.sendEmotionEvent(eventPage).whenComplete(() {
      ...
      this._startCollecting(nameScreen);
    });
  }

  // Start collecting gestures
  void _startCollecting(String? screenName) {
    print("Start Capture Touch ....");
    GestureBinding.instance.pointerRouter.addGlobalRoute((event) {
      if (event is PointerDownEvent) {
        ...
        if (!wasScrolled) {
          ...
          sendEmotionEvent(
              FSEmotionEvent("", cpoString, "", currentScreenName));
        } else {
          String cpString =
          ...
          // Send Event for move
          sendEmotionEvent(FSEmotionEvent(
              cpString, "cpoString", spoString, currentScreenName));
        ...
        // Événement annulé par le système
        debugPrint(
